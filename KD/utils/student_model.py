...
from .layers_student import GuideDecoder
...
class LanGuideMedSeg_student(nn.Module):

    def __init__(self, bert_type, vision_type, project_dim=512):

        super(LanGuideMedSeg_student, self).__init__()
    ...
    def forward(self, data):
        ...
        os16, vis_img16 = self.decoder16(os32,image_features[2], text_embeds[-1])
        os8, vis_img8 = self.decoder8(os16,image_features[1], text_embeds[-1])
        os4, vis_img4 = self.decoder4(os8,image_features[0], text_embeds[-1])
        ...
        return out, vis_img16, vis_img8, vis_img4
